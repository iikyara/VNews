...
{
	//$link = mysqli_connect('localhost', 'vnews', '8zDLWhfaxfZQ2yEE', 'vnews');
  $link = mysqli_connect('localhost', 'root', '', 'vnews');
	if(mysqli_connect_errno()){
		error("Connect failed: ".mysqli_connect_error());
	}
	//$link->set_charset('utf8');
	//echo $link == null ? 'error connecting' : 'success connecting';
	return $link;
}
